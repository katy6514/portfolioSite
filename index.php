    ...
    <main id="home-page" class="main-content">
        <div class="section group">
            <div class="col span_2_of_3">
                ...
                <p>I'll be attempting a thru-hike of the <a href="http://www.pcta.org/" target="_blank">PCT</a> during the summer of 2016, apologies if I appear unresponsive! I might just be a little lost in the woods.</p>

            </div>
            <div class="col span_1_of_3">
                <p id="profile_pic"><img src="./img/yellow_sweater_cwicket.JPG" /></p>
                <p class="img_caption">Me and a tiny monster/dog: Cricket</p>
            </div>
        </div>
        <div class="section group">
